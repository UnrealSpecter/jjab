<template>
    ...
    <div id="juridisch-advies" data-emergence="hidden" data-animation="animated fadeInUp" class="mb-16 shadow-md rounded-jjab flex flex-col justify-center items-center w-full bg-jjab-purple p-16">
        ...
        <div class="button-wrapper flex flex-row justify-center w-1/2 items-center tracking-2px">
            <brand-button href="stel-je-vraag">Mail</brand-button>
            <span class="text-4rem text-white anton h-full flex-center p-5">of</span>
            <brand-button href="contact">App</brand-button>
        </div>
