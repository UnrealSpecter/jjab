<div class="section-wrapper flex-r align-v col-12 no-padding-margin" style="height: 100vh; width: 100vw; background-color: #ef7c38;">
    ...
    <div class="col-4 offset-1 flex-r " style="position: absolute; bottom: 30%; padding: 0;">
    <a class="offset-4 col-2" href="mailto:renda.wesley@gmail.com?subject=probleem JJAB
    ...
    <a class="col-2" href="https://www.linkedin.com/in/stichting-jjab-0a3594159/" target="_blank">
    ...
    <div class="contact-text d-none animated col-12 offset-4 flex-c align-v justify-c">
